<div class="space-y-6">
    ...
    <ol class="list-decimal pl-5 space-y-1">
        ...
        <li>Jangan bandingkan tubuhmu dengan standar di media sosial — fokus pada kesehatanmu sendiri.</li>
        <li>Latih keberanian untuk berkata "tidak" pada permintaan yang membuatmu tidak nyaman.</li>
        <li>Cari orang dewasa terpercaya untuk diajak bicara jika ada hal yang membuatmu khawatir soal tubuh atau hubunganmu.</li>
    </ol>

    <h3 class="font-semibold text-brand-ink text-lg">Penutup: Cintai Tubuhmu Sendiri</h3>

    <p>
        Tubuhmu adalah rumah pertamamu. Setiap perubahan yang kamu alami adalah bagian dari
    ...
    <x-tip-box title="Butuh Teman Cerita?" icon="🤝">
        ...
        <p>Jika mengalami tekanan atau ancaman dalam hubungan, segera bicarakan dengan orang dewasa terpercaya atau layanan perlindungan anak/remaja setempat.</p>
    </x-tip-box>

    <p class="text-center font-semibold text-brand-ink italic">Kenali, terima, dan cintai tubuhmu. Kamu berharga apa adanya. 🌸</p>
</div>
